...
This project is indexed by GitNexus as **DentalAutomation** (344 symbols, 674 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/DentalAutomation/process/{processName}` — trace the full execution flow step by step
